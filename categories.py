...
def involvedCategories(files):
  stagedFiles = [x for x in files]
  stagedPackages = set(x for x in stagedFiles)
...
CMSSW_CATEGORIES={"Operations": ["Configuration/Applications",
  ...
  "Utilities/XrdAdaptor"], "Documentation": ["Documentation/CodingRules",
  ...
  "RecoJets/JetPlusTracks", "RecoJets/JetProducers"], "Database":
  ...
  "QCDAnalysis/Skimming", "QCDAnalysis/UEAnalysis"], "Fast Simulation":
  ...
  "Validation/EcalTriggerPrimitives"], "Calibration and Alignment":
  ["CondFormats/EgammaObjects", "CondFormats/GeometryObjects",
  "CondFormats/HIObjects", "CondFormats/HLTObjects", "CondFormats/HcalMapping",
  ...
  "DataFormats/Alignment", "RecoVertex/BeamSpotProducer"], "Full Simulation":
